          ...
          {user ? (
            <>
              ...
              >
                <Button
                  type="text"
                  className="h-10 px-3 rounded-xl hover:bg-gray-100 transition-all duration-300 flex items-center gap-2"
                >
                  <Avatar
                    size={32}
                    icon={<UserOutlined />}
            ...
            <Footer className="text-center bg-white/50 backdrop-blur-sm border-t border-gray-200/50 py-6">
              <div className="max-w-7xl mx-auto px-4">
                <p className="text-gray-600">
                  اختبارات الألمانية ©{new Date().getFullYear()} - أنشئ، شارك،
                  وتعلّم مع TuniBless e.v
                </p>
              </div>
            </Footer>
          </Layout>
